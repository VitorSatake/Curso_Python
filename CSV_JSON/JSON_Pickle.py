...
API -> Sao meios de comunicação entre os serviços oferecidos por empresas (Twiter, Facebook, Youtube)
...
ret = json.dumps(felix.__dict__) # deixando aspas duplas para formato json
